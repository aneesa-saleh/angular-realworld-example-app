...
upload_junit_results_url="https://api.zephyrscale.smartbear.com/v2/automations/executions/junit?projectKey=$project_key&autoCreateTestCases=$auto_create_test_cases"
