describe("Authentication", () => {
  ...
  it("WHEEL verify correct req and res - PRAC-T1", () => {
  ...
  it("verify global feed likes count", { retries: 1 }, () => {
    ...
    cy.get("app-article-list button").click().should("contain", "2213"); // wrong: 2204
  });
});
